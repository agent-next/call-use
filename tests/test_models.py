...
class TestEnums:
    def test_call_state_enum_values(self):
        expected = {
            "created", "dialing", "ringing", "connected", "in_ivr",
            "on_hold", "in_conversation", "awaiting_approval",
    ...
    def test_call_event_type_values(self):
        expected = {
            "state_change", "transcript", "dtmf", "approval_request",
            "approval_response", "takeover", "resume", "error",
            "call_complete",
        }
    ...
    def test_call_error_code_values(self):
        expected = {
            "dial_failed", "no_answer", "busy", "voicemail",
            "mid_call_drop", "timeout", "provider_error",
